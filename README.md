...
- run `create-reagent-app`
  ...
  clj -Sdeps '{:deps
    ...
    -X clj-new/create \
    :template '"https://github.com/athomasoriginal/create-reagent-app@4ec34b2b53017289e0d166e0c80fa73edafbca93"' \
...
- Add the following alias to the `deps.edn` file in `~/.clojure`
  ...
  {:aliases
   {:create-reagent-app
    {:extra-deps {seancorfield/clj-new {:mvn/version "1.2.362"}}
     :ns-default clj-new
     :exec-args  {:template "https://github.com/athomasoriginal/create-reagent-app@4ec34b2b53017289e0d166e0c80fa73edafbca93"}}}}
  ```
